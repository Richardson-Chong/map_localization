...
public:
    ...
    CPplane CP_tempt = CPplane(CPp(0,0,0));
    CPplane CP_last = CPplane(CPp(0,0,0));
    CPplane CP_cur = CPplane(CPp(0,0,0));
        ...
        {   
            ...
            {   
                ...
                *laserCloudRawLast = *cloud_temp;
                ...
                // pcl::io::savePCDFileBinary(map_path + "SCpointclouds.pcd", *prevKeyframeCloud);
                ...
                if(!gps_usage)
                {
                    ...
                    if(!gps_usage){
                        ...
                        cout<<"ICP Transition and rotation are: "<<correctionLidarFrame(0,3)<<" "
                                   <<correctionLidarFrame(1,3)<<" "
                                   ...
                                   <<eulerAngle_cur[2]<<" "                                  
                                   <<endl<<endl;
                        cout<<"SC Map Transition and rotation are: "<<Tpre2W(0,3)<<" "
                                   <<Tpre2W(1,3)<<" "
                                   <<Tpre2W(2,3)<<" "
                                   <<eulerAngle_SC[0]<<" "
                                   <<eulerAngle_SC[1]<<" "
    ...
    void extractSurroundingKeyFramesMap(){
        ...
        cout<<"提取到的周边点云的点运数: "<<surroundingClouds->size()<<endl;
    ...
    void saveKeyFramesAndFactor()
    {
        ...
        if(cloudKeyPoses6D->size()>keyframenumber) cloudKeyPoses6D->erase(cloudKeyPoses6D->begin());
        ...
        if(cornerCloudKeyFrames.size()>keyframenumber) {
